        ...
        throw new HttpException(
          {
            status: HttpStatus.UNPROCESSABLE_ENTITY,
            errors: {
              message: 'Username exists. Use a different one.',
            },
          },
          HttpStatus.UNPROCESSABLE_ENTITY,
        );
        ...
        throw new HttpException(
          {
            status: HttpStatus.UNPROCESSABLE_ENTITY,
            errors: {
              message: 'Image does not exist. Check and retry.',
            },
          },
          HttpStatus.UNPROCESSABLE_ENTITY,
        );
        ...
        throw new HttpException(
          {
            status: HttpStatus.UNPROCESSABLE_ENTITY,
            errors: {
              message: 'Role does not exist. Check and retry.',
            },
          },
          HttpStatus.UNPROCESSABLE_ENTITY,
        );
        ...
        throw new HttpException(
          {
            status: HttpStatus.UNPROCESSABLE_ENTITY,
            errors: {
              message: 'Status does not exist. Check and retry.',
            },
          },
          HttpStatus.UNPROCESSABLE_ENTITY,
        );
